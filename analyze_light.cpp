...
int main() {
  ...
  utility.initalise_scintillation_functions_xenon(parameters::t_singlet_Xe, parameters::t_triplet_Xe, parameters::singlet_fraction_Xe, parameters::triplet_fraction_Xe,
    ...
    //for non-random FE event generation
    double bin_size = sqrt((parameters::x_position_range[1]-parameters::x_position_range[0])*(parameters::y_position_range[1]-parameters::y_position_range[0])/(double)parameters::max_events_FE);  // cm

    std::cout<<"Bin size = "<<bin_size<<endl;
    int step_x = (int)(parameters::x_position_range[1]-parameters::x_position_range[0])/bin_size;
    int step_y = (int)(parameters::y_position_range[1]-parameters::y_position_range[0])/bin_size;
	...
	if(parameters::gen_alpha_gamma == true) {
        ...
        if(parameters::fixed_energy == true || parameters::gen_argon == true || parameters::gen_Ar42 == true || parameters::gen_K42 == true || parameters::gen_Bi214 == true || parameters::gen_Pb214 == true || parameters::gen_Kr85B1 == true || parameters::gen_Kr85B2 == true || parameters::supernova == true || parameters::solar == true || parameters::gen_hep == true || parameters::gen_Kr85G1 == true || parameters::gen_Kr85G2 == true){
          if(parameters::uniform_events == true){
            double x = 0, y =0, z = 0;
            int level_x = event/step_x;
            int level_y = event%step_x;

            y = (level_y+0.5)*bin_size;
            x = (level_x+0.5)*bin_size;
            position_list[event][0] = x+parameters::x_position_range[0];
            position_list[event][2] = (parameters::z_position_range[0]+parameters::z_position_range[1])/2.0;
            position_list[event][1] = y+parameters::y_position_range[0];
          }
          else{
